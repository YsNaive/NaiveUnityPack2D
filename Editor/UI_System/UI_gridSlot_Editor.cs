...
public class UI_gridSlot_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		{
				UI_gridSlot.backGround = (Sprite)EditorGUILayout.ObjectField("BackGround", UI_gridSlot.backGround, typeof(Sprite), false);
		...
		else if (UI_gridSlot.isGenerateByItemList)
        {
			...
			if (GUILayout.Button("Display")) UI_gridSlot.reflushByItemList();
		}
        else
        {			
			base.OnInspectorGUI();
			...
			{
					UI_gridSlot.addSlot("Slot", UI_gridSlot.icon, UI_gridSlot.backGround, UI_gridSlot.itemW, UI_gridSlot.itemH,false);
			}
			if (GUILayout.Button("Add preview Slot"))
					UI_gridSlot.addSlot("previewSlot", null, null, UI_gridSlot.itemW, UI_gridSlot.itemH,true);
