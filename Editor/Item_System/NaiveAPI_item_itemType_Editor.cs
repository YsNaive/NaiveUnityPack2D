...
[CustomEditor(typeof(NaiveAPI_item_itemType))]
public class NaiveAPI_item_itemType_Editor : Editor
{
    public NaiveAPI_item_itemType Target
    {
        get
        {
            return this.target as NaiveAPI_item_itemType;
        }
    }
